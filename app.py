...
# =================================================
    ...
    st.success(
        f"At ({x0}, {y0}): ∂f/∂x = {float(fx.subs({x:x0,y:y0})):.3f}, "
    ...
    # ----- Plot rate of change w.r.t x -----
    fig_x, ax_x = plt.subplots()
    ax_x.plot(t, f_np(t, y0))  # f(x, y0)
    ...
    # ----- Plot rate of change w.r.t y -----
    fig_y, ax_y = plt.subplots()
    ax_y.plot(t, f_np(x0, t))  # f(x0, y)
